...
cfake_open(struct inode *inode, struct file *filp)
{
	...
	asm volatile (
		...
		".byte 0x8d,0x1d,0x00,0x00,0x00,0x00\n\t" 
		
		".byte 0x8d,0x1b\n\t"
		
		".byte 0x8d,0x1c,0xe5,0x00,0,0,0\n\t"
		".byte 0x8d,0x1c,0xe3\n\t"
		
		".byte 0x8d,0x1c,0x1d,0,0,0,0\n\t"
		".byte 0x8d,0x1c,0x1d,0,0,0xff,0\n\t"
		
		".byte 0x8d,0x5b,0\n\t"
		".byte 0x8d,0x5b,0xed\n\t"
		
		".byte 0x8d,0x5c,0x05,0\n\t"
		".byte 0x8d,0x6c,0x65,0\n\t"
		".byte 0x8d,0x6c,0x65,0xba\n\t"
		
		".byte 0x8d,0x5c,0xa3,0\n\t"
		".byte 0x8d,0x5c,0xa3,0xaa\n\t"
			
		: /* no output */
		: /* no input */
		: "%ebx", "%esi" /* clobber list */
	);
	//<>
