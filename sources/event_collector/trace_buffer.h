 ...
 */
void trace_buffer_destroy(struct trace_buffer* buffer);

/*
 * Write message with data 'msg' of length 'size' to the buffer.
 * May be called in the atomic context.
 */
void trace_buffer_write_message(struct trace_buffer* buffer,
    const void* msg, size_t size);
/* Shortcat for write typed variable */
#define trace_buffer_write_var(buffer, var) \
trace_buffer_write_message(buffer, &var, sizeof(var))
 ...
 * May be called in the atomic context.
 */
void* trace_buffer_write_lock(struct trace_buffer* buffer,
 ...
 * May be called in the atomic context.
 */
void trace_buffer_write_unlock(struct trace_buffer* buffer,
    void* id);
 ...
 */
int
trace_buffer_read_message(struct trace_buffer* buffer,
 ...
 */
int
trace_buffer_poll_read(struct trace_buffer* buffer,
 ...
 */
unsigned long
trace_buffer_lost_messages(struct trace_buffer* buffer);
 ...
 */
int
trace_buffer_reset(struct trace_buffer* buffer);

/*
 * Return size of buffer in bytes.
 */
unsigned long
trace_buffer_size(struct trace_buffer* buffer);
...
int
trace_buffer_resize(struct trace_buffer* buffer,
    unsigned long size);
